...
abstract Matrix1x2( geom.structure.Mat1x2 ) from geom.structure.Mat1x2 to geom.structure.Mat1x2 {
    ...
    /**
     * <pre><code>
     * >>> Equal.equals( Matrix1x2.zero(), new Matrix1x2({ x: 0., y: 0. }) ) == true
     * </code></pre>
     */
    ...
    /**
     * <pre><code>
     * >>> Equal.equals( Matrix1x2.unit(), new Matrix1x2({ x: 1., y: 1. }) ) == true
     * </code></pre>
     */
    public static inline
    function unit(){
    ...
    /**
     * <pre><code>
     * >>> Equal.equals( Matrix1x2.topLeft(), new Matrix1x2({ x: -1., y: 1. }) ) == true
     * </code></pre>
     */
    public static inline
    function topLeft(){
    ...
    /**
     * <pre><code>
     * >>> Equal.equals( Matrix1x2.topRight(), new Matrix1x2({ x: 1., y: 1. }) ) == true
     * </code></pre>
     */
    public static inline
    function topRight(){
    ...
    /**
     * <pre><code>
     * >>> Equal.equals( Matrix1x2.bottomLeft(), new Matrix1x2({ x: -1., y: -1. }) ) == true
     * </code></pre>
     */
    public static inline 
    function bottomLeft(){
    ...
    /**
     * <pre><code>
     * >>> Equal.equals( Matrix1x2.bottomRight(), new Matrix1x2({ x: 1., y: -1. }) ) == true
     * </code></pre>
     */
    public static inline
    ...
    /**
     * <pre><code>
     * >>> Equal.equals( Matrix1x2.north(), new Matrix1x2({ x: 0., y: 1. }) ) == true
     * </code></pre>
     */
    public static inline
    function north(){
    ...
    /**
     * <pre><code>
     * >>> Equal.equals( Matrix1x2.south(), new Matrix1x2({ x: 0., y: -1. }) ) == true
     * </code></pre>
     */
    public static inline
    function south(){
    ...
    /**
     * <pre><code>
     * >>> Equal.equals( Matrix1x2.west(), new Matrix1x2({ x: -1., y: 0. }) ) == true
     * </code></pre>
     */
    public static inline
    function west(){
    ...
    /**
     * <pre><code>
     * >>> Equal.equals( Matrix1x2.east(), new Matrix1x2({ x: 1., y: 0. }) ) == true
     * </code></pre>
     */
    public static inline
    function east(){
    ...
    /**
     * <pre><code>
* >>> Equal.equals( Matrix1x2.unit() + Matrix1x2.unit(), new Matrix1x2( { x: 2., y: 2. } ) ) == true
     * </code></pre>
     */
    ...
    /**
     * <pre><code>
* >>> Equal.equals( Matrix1x2.unit() - Matrix1x2.unit(), new Matrix1x2( { x: 0., y: 0. } ) ) == true
     * </code></pre>
     */
    @:op(A - B) public static inline
    ...
    /**
     * <pre><code>
     * >>> Equal.equals( Matrix1x2.unit() * 2, new Matrix1x2( { x: 2., y: 2. } ) ) == true
     * >>> Equal.equals( 2 * Matrix1x2.unit(), new Matrix1x2( { x: 2., y: 2. } ) ) == true
     * </code></pre>
     */
    ...
    /**
     * <pre><code>
     * >>> Equal.equals( Matrix1x2.unit() / 2, new Matrix1x2( { x: 0.5, y: 0.5 } ) ) == true
     * </code></pre>
     */
    @:op(A / B) public static inline
     ...
     * <pre><code>
     * >>> ({ var a = new Matrix1x2({x:1.,y:1.}); var b = new Matrix1x2({x:1.+3.,y:1.+4.}); a.distanceBetweenSquare( b ); }) == 25
     * </code></pre>
     */
    public inline
     ...
     * test with 3,4,5 triangle
     * <pre><code>
     * >>> ({ var a = new Matrix1x2({x:1.,y:1.}); var b = new Matrix1x2({x:1.+3.,y:1.+4.}); a.distanceBetween( b ); }) == 5
     * </code></pre>
     */
    public inline
    ...
    /**
     * <pre><code>
     * >>> ({ var a=new Matrix1x2({x:3.,y:3.}); a.lenSquare(); }) == 18
     * </code></pre>
     */
    public inline
    ...
    /**
     * <pre><code>
     * >>> ({ var a=new Matrix1x2({x:3.,y:4.}); a.distance(); }) == 5
     * </code></pre>
     */
    public inline
...
// < 0, p is righ of line, clockwise
    ...
    /**
     * <pre><code>
     * >>> ({ var a = Matrix1x2.topRight()/2; var b = Matrix1x2.zero(); var c = Matrix1x2.topRight(); a.inRect( b, c ); }) == true
     * >>> ({ var a = Matrix1x2.bottomLeft()/2; var b = Matrix1x2.zero(); var c = Matrix1x2.topRight(); a.inRect( b, c ); }) == false
     * >>> ({ var a = Matrix1x2.bottomLeft()/2; var b = Matrix1x2.bottomRight(); var c = Matrix1x2.zero(); a.inRect( b, c ); }) == false
     * >>> ({ var a = Matrix1x2.bottomRight()/2; var b = Matrix1x2.bottomRight(); var c = Matrix1x2.zero(); a.inRect( b, c ); }) == true
     * </code></pre>
     */
    public inline
    ...
    /**
     * <pre><code>
     * >>> ({ var a = new Matrix1x2({x:0.5,y:0.5}); var b = new Matrix1x2({x:0.5000001,y:0.5000001}); a.close( b ); }) == true
     * </code></pre>
     */
    public inline
    ...
    /**
     * <pre><code>
     * >>> ({ var a = new Matrix1x2({x:0.5,y:1.}); var b = new Matrix1x2({x:0.5000001,y:0.5000001}); a.close( b ); }) == true
     * </code></pre>
     */
    public inline
    ...
    /**
     * <pre><code>
     * >>> ({ var a = new Matrix1x2({x:1.,y:0.5}); var b = new Matrix1x2({x:0.5000001,y:0.5000001}); a.close( b ); }) == true
     * </code></pre>
     */
    public inline
    ...
    /**
     * <pre><code>
     * >>> ({ var a = Matrix1x2.topRight(); var b = a.pivotAround( Math.PI/2, Matrix1x2.topRight()/2 ); b.close( Matrix1x2.north() ); }) == true
     * </code></pre>
     */
    public inline
